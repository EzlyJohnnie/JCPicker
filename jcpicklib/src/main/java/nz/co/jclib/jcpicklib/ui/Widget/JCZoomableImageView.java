...
public class JCZoomableImageView extends ImageView
{
    Matrix matrix;
    ...
    public JCZoomableImageView(Context context) {
        super(context);
        sharedConstructing(context);
    }

    public JCZoomableImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructing(context);
    }
