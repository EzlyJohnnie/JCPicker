 ...
 */
public class JCEditText extends EditText {

    private Context context;

    public JCEditText(Context context) {
        super(context);
        this.context = context;
        init(null);
    }

    public JCEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
    }

    public JCEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public JCEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
